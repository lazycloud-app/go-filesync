...
func (e ErrorType) String() string {
	...
	return [...]string{"Unknown err type", "Broken message", "Unknown message type", "Access denied", "Sync app internal error", "Too much errors on server side", "Too much errors on client side", "Server has reached client limits", "Client has reached connections limit", "Incompatible app version", "Incompatible protocol version", "Incompatible conditions", "Unknown connection intension", "Unpermitted connection intension", "I have newer version", "Unknown err type"}[e]
}
